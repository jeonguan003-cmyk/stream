...
st.set_page_config(page_title='Streamlit 실습', page_icon='🙆‍♂️', layout='wide')
...
if selected_day == '1일차 : 7월 6일(월)':
    ...
    with tab_assignment1:
        ...
        with col_profile:
            st.header("내 프로필")
            st.subheader("안정우")
            st.write("고등학교 1학년, 미래의 아인슈타인")
            st.write("관심사: 물리학, 천문학, 수학, 디저트")
...
elif selected_day == '2일차 : 7월 10일(수)':
    with tab_practice:
        st.header('5일차 실습예제')
